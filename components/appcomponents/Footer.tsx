      ...
      <div className="mx-auto px-4 md:px-8 py-8 max-w-7xl ">
        <div className="grid gap-8 grid-cols-1 md:grid-cols-3">
          ...
          <div className="space-y-4">
            <div className="flex flex-col items-center gap-3">
              <Image
                ...
                className="h-12 w-12"
              />
              <span className="text-sm text-center font-semibold text-[#DC0D15]">T.C. Çalışma ve Sosyal Güvenlik Bakanlığı</span>
            </div>
          ...
          <div className="space-y-4  ">
            ...
            <h3 className="text-[#DC0D15]/85 ">Hızlı Erişim</h3>
            <ul className="space-y-2 text-sm  ">
              <li>
                <a href="https://www.csgb.gov.tr/uigm/tr" target="_blank" className="text-slate-600 hover:text-slate-800">
                  Ana Sayfa
                </a>
              </li>
              
              <li>
                <a href="https://kms.kaysis.gov.tr/Home/kurum/24304011?AspxAutoDetectCookieSupport=1" target="_blank" className="text-slate-600 hover:text-slate-800">
                  Mevzuat
                </a>
              </li>
              <li>
                <a href="https://www.csgb.gov.tr/uigm/tr/yayin-ve-%C4%B1statistik/%C4%B1statistikler" target="_blank" className="text-slate-600 hover:text-slate-800">
                  Yayınlar
                </a>
              </li>
              <li>
                <a href="https://www.csgb.gov.tr/uigm/tr/%C4%B1letisim" target="_blank" className="text-slate-600 hover:text-slate-800">
                  İletişim
                </a>
              </li>
            </ul>
          ...
          {/* İletişim */}
          <div className="space-y-4 ">
            <h3 className=" text-[#DC0D15]/85">İletişim</h3>
            <ul className="space-y-2 text-sm ">
          ...
          <div className="space-y-4 flex flex-col">
            <h3 className="text-[#DC0D15]/85">Sosyal Medya</h3>
